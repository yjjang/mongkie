...
public final class HeatMapTopComponent extends TopComponent implements SeriesModelListener {
    ...
    public HeatMapTopComponent() {
        ...
        gradientColors = new Color[]{ColorLib.getColor(44, 123, 182),
            ColorLib.getColor(255, 255, 191),
            ColorLib.getColor(215, 25, 28)};
...
//        heatmapPanel.setCoordinateBounds(0, 10, 0, 20);
    ...
    /**
     * Obtain the HeatMapTopComponent instance. Never call {@link #getDefault}
     * directly!
     */
